...
INSERT INTO `order_state` VALUES (6,'cancelado'),(2,'confirmado'),(5,'entregado'),(4,'enviando'),(1,'nuevo'),(3,'preparando');
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`payment_method_id`),
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`order_state_id`) REFERENCES `order_state` (`order_state_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment_method` VALUES (1,'efectivo'),(2,'tarjeta');
...
CREATE TABLE `products_orders` (
  ...
  KEY `product_id` (`product_id`),
  CONSTRAINT `products_orders_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `products_orders_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-17 17:21:32
