...
exports.signupValidations = () => {
  return [
    ...
    check("address").notEmpty().withMessage("Address is required").isLength({ max: 255 }).withMessage("Address cannot be longer than 255 characters"),
    check("password")
      .notEmpty()
...
exports.loginValidations = () => {
  return [check("email").isEmail().withMessage("Email is not valid"), check("password").notEmpty().withMessage("Password is required")];
};
